		...
		<div class="input-group mb-3">
			...
			<div style="width: 400px; border-radius: 5px; margin-right: 20px;">
				<select name="type" class="form-select" id="inputGroupSelect02">
					<option ${ph.pgvo.type == null ? 'selected' : '' } value="twc">전체</option>
			...
			<input type="text" class="form-control me-2" name="keyword" value="${ph.pgvo.keyword }" 
			placeholder="Search.." style="border-radius: 5px;"> 
			<input type="hidden" name="pageNo" value="1"> <input type="hidden" name="qty" value="10">
			...
			<ul class="pagination">
				...
				<c:forEach begin="${ph.startPage }" end="${ph.endPage }" var="i">
					<li class="page-item ${ph.pgvo.pageNo == i ? 'active' : '' }"><a
						class="page-link" href="/board/list?pageNo=${i }&type=${ph.pgvo.type}&keyword=${ph.pgvo.keyword}"> ${i }</a></li>
				</c:forEach>
