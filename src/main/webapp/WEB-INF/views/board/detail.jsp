...
<div class="container-md">
	...
	<div class="mb-3">
		<label for="content" class="form-label">수정일 </label> <input
			type="text" name="writer" class="form-control" id="writer"
			placeholder="Wirter" value="${bvo.modAt }" readonly="readonly">
	</div>
	<div class="mb-3">
	...
	<div class="mb-3">
		<label for="readCount" class="form-label">댓글수 </label> <input
			type="text" name="readCount" class="form-control" id="readCount"
			placeholder="Wirter" value="${bvo.cmtQty }" readonly="readonly">
	</div>
	<div class="mb-3">
		<label for="readCount" class="form-label">파일수 </label> <input
			type="text" name="readCount" class="form-control" id="readCount"
			placeholder="Wirter" value="${bvo.hasFile }" readonly="readonly">
	</div>
	<div class="mb-3">
